...
<table width="650" border="0" align="center"style="border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; border-collapse: collapse;">
  ...
  <tr>
    ...
    <td width="369" align="center"><span style="font-weight: bold;">Purchase Tax Invoice&nbsp;:&nbsp;&nbsp;<?php echo $arr->orderid;?></span></td>
...
<table width="650" border="0" align="center" style="border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; border-collapse: collapse;font-size:14px;">
  ...
  <tr>
    ...
    <td rowspan="3" align="left" style="border-right: 1px solid black;"><p style="padding: 4px;"><strong ><?php echo $arr->companyname;?><br><?php echo $arr->address;?>&nbsp;<br><?php echo $arr->pincode;?><?php echo $arr->city;?>&nbsp;<?php echo $arr->state;?></strong><br><strong style="font-size:14px;">Attn :<?php echo $arr->name;?></p></td>
